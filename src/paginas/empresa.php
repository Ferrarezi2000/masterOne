                ...
                <div class="tm-slider-container full-width-slider" data-parallax data-animation="slide"
                    ...
                    <ul class="tms-slides">
                        <li class="tms-slide" data-image data-force-fit>
                            ...
                            <img data-src="../../imagens/minhas_imagens/empresa/capa.jpg" data-retina
                ...
                <section class="section-block replicable-content">
                    <div class="row">
                        <div class="column width-3">
                            <h3 class="mb-50">Master One</h3>
                        </div>
                        <div class="column width-8 offset-1">
                            <div class="flex">
                                <div class="grid-item no-margin-bottom">
                                    <h6 class="mb-30 weight-bold text-uppercase">Sobre a Master One</h6>
                                    <p class="mb-50" style="text-align: justify">
                                        A MasterOne é uma empresa jovem criada por profissionais ativos no mercado
                                        SAP
                                        Business One, aqui você está falando com quem realmente entende e vivencia o
                                        processo
                                        de implantação de softwares.
                                    </p>

                                    <p class="mb-50" style="text-align: justify">
                                        Com mais de 10 anos de experiência no mercado de software, os profissionais
                                        estão
                                        prontos para lhe entregar uma implantação de qualidade, que irá levar a sua
                                        empresa para
                ...
                <div class="section-block replicable-content team-2 bkg-grey-ultralight">
                    <div class="row">
                        <div class="column width-6">
                            <h3 class="mb-50">Equipe</h3>
                        </div>
                        <div class="column width-12">
                            <div class="row content-grid-3">
                                <div class="grid-item horizon"
                                     data-animate-in="preset:slideInUpShort;duration:1000ms;" data-threshold="0.3">
                                    <div class="thumbnail no-margin-bottom" data-hover-easing="easeInOut"
                                         data-hover-speed="500" data-hover-bkg-color="#ffffff"
                                         data-hover-bkg-opacity="0.9">
                                        <img src="../../imagens/minhas_imagens/empresa/team-member-1.jpg"
                                ...
                                <div class="grid-item horizon"
                                    ...
                                    <div class="thumbnail no-margin-bottom" data-hover-easing="easeInOut"
                                         data-hover-speed="500" data-hover-bkg-color="#ffffff"
                                         data-hover-bkg-opacity="0.9">
                                        <img src="../../imagens/minhas_imagens/empresa/team-member-2.jpg"
                                             width="600" height="500" alt=""/>
                                    </div>
                                    <div class="team-content-info">
                                ...
                                <div class="grid-item horizon"
                                    ...
                                    <div class="thumbnail no-margin-bottom" data-hover-easing="easeInOut"
                                         data-hover-speed="500" data-hover-bkg-color="#ffffff"
                                         data-hover-bkg-opacity="0.9">
                                        <img src="../../imagens/minhas_imagens/empresa/team-member-3.jpg"
                                             width="600" height="500" alt=""/>
                                    </div>
                                    <div class="team-content-info">
                                    ...
                                    <div class="row">
                                        <div class="column width-12">
                                            <blockquote class="center large">
                                                <p>Incredible work! Best creative experience ever; timely, well executed
                                                    and one hell of the result. Would recommend Nietszche to anyone who
                                                    is looking to revamp their identity.
                            ...
                            <li class="tms-slide" data-image>
                                <div class="tms-content-scalable">
                                    <div class="row">
                                        <div class="column width-12">
                                            <blockquote class="center large">
                                                <p>Creativity redefined. These guys offer a unique approach to every
                                                    aspect<br> of design and the result is simply stunning.
                            ...
                            <li class="tms-slide" data-image>
                                <div class="tms-content-scalable">
                                    <div class="row">
                                        <div class="column width-12">
                                            <blockquote class="center large">
                                                <p>Design, design and redesign is their motto. Sartre won't stop until
                                                    they have<br> the perfect match between functionality and esthetic.
