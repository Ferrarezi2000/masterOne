...
<form action="../../php/bancoDados/cadastro-post.php" method="POST" enctype="multipart/form-data"
    ...
    <div class="form-group">
        <div class="controls">
            <input type="text" id="titulo" class="floatLabel" name="titulo" required />
    ...
    <div class="form-group">
        <div class="controls">
            <textarea name="texto" class="floatLabel" id="texto" required ></textarea>
