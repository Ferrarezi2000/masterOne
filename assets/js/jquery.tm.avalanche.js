...
;(function( $, document, window, undefined ) {
	...
	*/
	...
	function preload( slider, settings, obj ){
		...
		slide.each( function(){
			...
			// Check the number of imagens, videos and captions
			...
			// If there are no imagens in the slide
			// fire loaded
			if( !totalSlideImgs ){
				totalSlides++;
				positionCarousel( slider, settings );
	...
	*/
	...
	$.fn.avalancheSlider.tmsOpts = {
		...
		// Scaling
		forceFit: false,								// Force fits all slide imagens to slide, use data-force-fit for individual imagens
		...
		// Retina Support
		retinaSupport: true,							// Check for retina displays and serve retina image, affects all imagens within a slide
