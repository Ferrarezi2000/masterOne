        ...
        <div class="side-navigation-inner">
            ...
            <nav class="side-navigation">
                <ul>
                    ...
                    <li>
                        <a href="src/paginas/empresa.php">Empresa</a>
                    </li>
                    <li>
                        <a href="src/paginas/servico.php">Produtos e Serviços</a>
                    </li>
                    <li>
                    ...
                    <div class="column width-12 nav-bar-inner">
                        <div class="logo">
                            <div class="logo-inner">
                                <a href="#"><img src="imagens/minhas_imagens/logo-menu/logo-dark-one.png"
                                                 alt="Logo"/></a>
                                                    ...
                                                    <div class="row">
                                                        <div class="column width-12 tms-perspective">
                                                            ...
                                                            <div class="tms-caption no-scale" style="width: 100%;
																     transform: translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scale3d(1, 1, 1); opacity: 1; transform-origin: 50% 50% 0px; visibility: visible;"
                                                            ...
                                                            <div class="clear"></div>
                                                            <ul class="tms-caption social-list list-horizontal no-margins scale"
                                                                data-animate-in="preset:slideInDownShort;duration:1000ms;delay:1000ms;"
                                                                style="transform: translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scale3d(1, 1, 1); opacity: 1; font-size: 9.1875px; line-height: 9.1875px; padding: 0px; margin: 0px; border-width: 0px; white-space: nowrap; top: 235.406px; left: 248.5px; transform-origin: 50% 50% 0px; visibility: visible;">
                                                                <li><a href="#"
                                                                       class="color-grey-light color-hover-white"><span
                                                                                class="icon-twitter-with-circle medium"></span></a>
                                                                </li>
                                                                <li><a href="#" class="color-grey-light"><span
                                                                                class="icon-facebook-with-circle medium"></span></a>
                                                                </li>
                                                                <li><a href="#" class="color-grey-light"><span
                                                                                class="icon-dribbble-with-circle medium"></span></a>
                                                                </li>
                                                                <li><a href="#" class="color-grey-light"><span
                                                                                class="icon-linkedin-with-circle medium"></span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
