													...
													<div class="tms-content-inner left left-on-mobile v-align-middle">
														<div class="row">
															<div class="column width-12 tms-perspective">
																<h1 class="tms-caption color-white weight-light mb-0 no-scale"
																	data-animate-in="preset:fadeIn;duration:1000ms;delay:100ms;"
																	data-no-scale="" style="transform: translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scale3d(1, 1, 1); opacity: 1; transform-origin: 50% 50% 0px; visibility: visible;">
																	Master One
																</h1>
																...
																<h3 class="tms-caption color-grey-light weight-light mb-20 mb-mobile-20 no-scale"
